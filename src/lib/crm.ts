// Constantes del CRM interno (equipo de Chaski). Centralizadas aca para que
// el orden/color/etiqueta de cada etapa sea consistente entre el pipeline
// (kanban), el detalle de contacto y cualquier filtro.

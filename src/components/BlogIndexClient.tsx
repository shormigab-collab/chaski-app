...
const FILTROS: { id: Filtro; etiqueta: string }[] = [
  ...
  { id: "Guía para freelancers", etiqueta: "Para profesionales" },
  { id: "Guía para clientes", etiqueta: "Para clientes" },
];
...
export default function BlogIndexClient() {
  ...
  return (
    <div className="relative overflow-hidden bg-cream">
      {/* chevrons decorativos, mismo motivo que en /registro */}
      <svg
      ...
      <div className="relative max-w-3xl mx-auto px-4 py-14 sm:py-16">
        ...
        >
          Ideas para trabajar y <span className="text-coral-600">contratar mejor.</span>
        </h1>
        <p className="text-ink/55 max-w-md mb-8">
          Guías claras para profesionales independientes y empresas de Latinoamérica.
        </p>
        ...
        {!destacado && <p className="text-sm text-ink/45 italic">Todavía no hay guías en esta categoría.</p>}
          ...
          >
            ...
            <div className="p-6 sm:p-7">
              <div className="flex items-center gap-2.5 mb-3">
                ...
                <span className="text-xs text-ink/40">{destacado.minutosLectura} min de lectura</span>
              </div>
        ...
        {recientes.length > 0 && (
          <div>
            <h2 className="text-xl font-bold text-ink mb-4">Guías recientes</h2>
                ...
                >
                  ...
                  <div className="min-w-0 py-1">
                    <div className="flex items-center gap-2 mb-1.5 flex-wrap">
                      ...
                      <span className="text-xs text-ink/40">{post.minutosLectura} min de lectura</span>
                    </div>

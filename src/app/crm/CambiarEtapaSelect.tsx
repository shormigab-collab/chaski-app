...
// Select compacto para mover un contacto de etapa directamente desde la
// tarjeta del pipeline (sin necesidad de arrastrar-y-soltar).
export default function CambiarEtapaSelect({ contactoId, etapaActual }: { contactoId: string; etapaActual: string }) {
  ...
  async function onChange(e: React.ChangeEvent<HTMLSelectElement>) {
    ...
    setCargando(true);
    const res = await fetch(`/api/crm/contactos/${contactoId}`, {
      method: "PUT",
